...
rm -rf Dubai%20South%20Website/.git
...
git pull https://$AZUSERNAME:$AZUREPAT@dev.azure.com/$AZORG/Dubai%20South%20Website/_git/Dubai%20South%20Website.git
...
git push --force https://$AZUSERNAME:$AZUREPAT@dev.azure.com/$AZORG/Dubai%20South%20Website/_git/Dubai%20South%20Website.git
